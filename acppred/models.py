...
class Model:
    ...
    def fit(self, X:Any, y:Any):
        ...
        - X (Any): training features in a scikit-learn-compatible format.
        - y (Any): training labels in a sci-kit-learn-compatible format.
    ...
    def predict_proba(self, X:Any):
        ...
        """
        Predicts label probabilities based on the underlying estimator.
